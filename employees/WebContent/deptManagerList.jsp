...
<body>
	...
	<div class="container"><br>
		...
		%>
			<li class="page-item">
				<a class="page-link" href="./deptManagerList.jsp?currentPage=1">처음으로</a>
			</li>
		<%
			}
			if(currentPage > 1) {
		%>
			<li class="page-item">
				<a class="page-link" href="./deptManagerList.jsp?currentPage=<%=currentPage-1%>">이전</a>
			</li>
		<%
			}
		%>
		...
		%>
			<li class="page-item">
				<a class="page-link" href="./deptManagerList.jsp?currentPage=<%=currentPage+1%>">다음</a>
			</li>
		<%
			}
			if (currentPage < lastPage) {
		%>
			<li class="page-item">
				<a class="page-link" href="./deptManagerList.jsp?currentPage=<%=lastPage%>">마지막으로</a>
			</li>
		<%
			}
		%>
